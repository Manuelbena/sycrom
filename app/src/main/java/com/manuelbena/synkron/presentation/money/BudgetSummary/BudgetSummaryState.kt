...
data class BudgetSummaryState(
    ...
    val formattedTotalIncome: String get() = String.format(Locale.getDefault(), "%.2f €", totalIncome)
    val formattedTotalLimit: String get() = String.format(Locale.getDefault(), "de %.2f €", totalLimit)
    val totalBalance: Double get() = totalIncome - totalSpent
    val formattedTotalBalance: String get() = String.format(Locale.getDefault(), "%.2f €", totalBalance)
}